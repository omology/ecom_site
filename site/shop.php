...
<?php include("../inc/comp/shop_nav.php");?>
 ...
 <section class="container mx-auto px-6 py-10 ">
    <!-- category of products  : -->
        <h2 class=" font-bold text-gray-800 text-4xl">laptop : </h2>
  ...
  <!-- ./laptop section  -->
   ...
   <section class="container mx-auto px-6 py-10 ">
    <!-- category of products  : -->
        <h2 class=" font-bold text-gray-800 text-4xl">keyboard </h2>
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-2.5">
  <!-- Product 2 -->
  <div class="bg-white shadow-lg rounded-lg overflow-hidden shadow-lg shadow-blue-500/40">
    ...
    <section class="container mx-auto px-6 py-10 ">
    <!-- category of products  : -->
        <h2 class=" font-bold text-gray-800 text-4xl"> mouses  </h2>
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-2.5">
              <!-- Product 4 : -->
              <div class="bg-white shadow-lg rounded-lg overflow-hidden shadow-lg shadow-blue-500/40">
    ...
    <section class="container mx-auto px-6 py-10 ">
    <!-- category of products  : -->
        <h2 class=" font-bold text-gray-800 text-4xl">casque </h2>
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-2.5">
  <!-- Product 4 -->
  <div class="bg-white shadow-lg rounded-lg overflow-hidden shadow-lg shadow-blue-500/40">
